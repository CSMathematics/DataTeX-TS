...
export interface Hover {
    contents: string | { value: string; kind?: string } | Array<{ value: string; kind?: string }>;
    range?: {
...
export class TexlabLspClient {
    ...
    async initialize(rootUri: string): Promise<void> {
        try {
            ...
            console.log('✅ Texlab LSP initialized:', rootUri);
        } catch (error) {
    ...
    async completion(
        ...
        try {
            console.log(`📤 LSP Request: completion at ${uri}:${line}:${character}`);
            ...
            console.log(`✅ Parsed ${items.length} completion items`);
    ...
    async didOpen(uri: string, languageId: string, text: string): Promise<void> {
        ...
        try {
            ...
            console.log(`📂 LSP didOpen: ${uri} (${text.length} chars, version ${version})`);
            ...
            console.log('✅ didOpen successful');
        } catch (error) {
    ...
    async didChange(uri: string, text: string): Promise<void> {
        ...
        try {
            ...
            console.log(`📝 LSP didChange: ${uri} (${text.length} chars, version ${version})`);
            ...
            console.log('✅ didChange successful');
        } catch (error) {
    ...
    async shutdown(): Promise<void> {
        ...
        try {
            ...
            console.log('🛑 Texlab LSP shutdown');
        } catch (error) {
