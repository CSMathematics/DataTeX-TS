...
import { Group, ActionIcon, Tooltip, Text, TextInput, Box, Select } from '@mantine/core';
import { IconArrowLeft, IconArrowRight, IconDownload, IconPrinter, IconZoomIn, IconZoomOut, IconArrowsMaximize, IconArrowsHorizontal } from '@tabler/icons-react';
        ...
        >
            ...
            <Group gap="xs">
                ...
                <Group gap={4}>
                    ...
                    />
                    <Text size="xs" c="dimmed">/ {numPages}</Text>
                </Group>
            ...
            <Group gap="xs">
                <Tooltip label="Zoom Out">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onZoomOut}>
                        <IconZoomOut size={16} />
                    </ActionIcon>
                </Tooltip>
                <Select
                ...
                <Tooltip label="Zoom In">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onZoomIn}>
                        <IconZoomIn size={16} />
                    </ActionIcon>
                </Tooltip>
            </Group>
            ...
            <Group gap="xs">
                <Tooltip label="Fit to Width">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onFitToWidth}>
                        <IconArrowsHorizontal size={16} />
                    </ActionIcon>
                </Tooltip>
                <Tooltip label="Fit to Page">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onFitToPage}>
                        <IconArrowsMaximize size={16} />
                    </ActionIcon>
                </Tooltip>
                <Tooltip label="Download">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onDownload}>
                        <IconDownload size={16} />
                    </ActionIcon>
                </Tooltip>
                <Tooltip label="Print">
                    <ActionIcon variant="subtle" color="gray" size="sm" onClick={onPrint}>
                        <IconPrinter size={16} />
                    </ActionIcon>
                </Tooltip>
            </Group>
...
export const PdfViewerContainer = memo(({ pdfUrl, onSyncTexInverse }: PdfViewerContainerProps) => {
    ...
    if (!pdfUrl) {
        return (
            <EmptyState message="No PDF available" />
        );
    }
    ...
    return (
        <Box h="100%" style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Box
                ref={containerRef}
                style={{ flex: 1, overflow: 'auto', backgroundColor: 'var(--mantine-color-dark-7)' }}
            ...
            >
                ...
                {error && (
                    <EmptyState message={error} bg="transparent" />
                )}
                <Document
                    file={pdfUrl}
