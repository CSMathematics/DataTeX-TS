  ...
  export const MATH_TOOLBAR_ITEMS: MathToolbarItem[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: "menu",
          items: [
            { id: "parentheses", text: "Parentheses: \\left(  \\right)", insert: "\\left( %<content%> \\right)", icon: "parentheses", type: "insert" },
            { id: "brackets", text: "Brackets: \\left[  \\right]", insert: "\\left[ %<content%> \\right]", icon: "brackets", type: "insert" },
            { id: "braces", text: "Braces: \\left{  \\right}", insert: "\\left\\{ %<content%> \\right\\}", icon: "braces", type: "insert" },
            { id: "anglebrackets", text: "Angle Brackets: \\left<  \\right>", insert: "\\left\\langle %<content%> \\right\\rangle", icon: "anglebrackets", type: "insert" },
            { id: "verticalbars", text: "Vertical Bars: \\left|  \\right|", insert: "\\left| %<content%> \\right|", icon: "verticalbars", type: "insert" },
            { id: "doubleverticalbars", text: "Norm: \\left‖  \\right‖", insert: "\\left\\| %<content%> \\right\\|", icon: "doubleverticalbars", type: "insert" },
            { id: "floor", text: "Floor: \\left⎣  \\right⎦", insert: "\\left\\lfloor %<content%> \\right\\rfloor", icon: "floor", type: "insert" },
            { id: "ceiling", text: "Ceiling: \\left⎡  \\right⎤", insert: "\\left\\lceil %<content%> \\right\\rceil", icon: "ceiling", type: "insert" },
...

        {
          ...
          items: [
            ...
            { id: "Proofsketch", text: "Proof Sketch (ntheorem)", insert: "\\begin{Proofsketch}%\n%|%\n\\end{Proofsketch}", info: "Needs \\usepackage[standard]{ntheorem}", type: "insert" },
            { id: "Axiom", text: "Axiom (ntheorem)", insert: "\\begin{Axiom}%\n%|%\n\\end{Axiom}", info: "Needs \\usepackage[standard]{ntheorem}", type: "insert" },
            { id: "Conjecture", text: "Conjecture (ntheorem)", insert: "\\begin{Conjecture}%\n%|%\n\\end{Conjecture}", info: "Needs \\usepackage[standard]{ntheorem}", type: "insert" },
            { id: "Notation", text: "Notation (ntheorem)", insert: "\\begin{Notation}%\n%|%\n\\end{Notation}", info: "Needs \\usepackage[standard]{ntheorem}", type: "insert" },
          ]
        },
...

        {
          ...
          items: [
            ...
            { id: "sep1", type: "separator" },
            { id: "substack", text: "\\substack (amsmath)", insert: "\\substack{%<line1%> \\\\ %<line2%>}", type: "insert" },
            { id: "prescript", text: "\\prescript (mathtools)", insert: "\\prescript{%<left exp%>}{%<left ind%>}{%<arg%>}", type: "insert" },
            { id: "mathclap", text: "\\mathclap (mathtools)", insert: "\\mathclap{%<content%>}", type: "insert" },
            { id: "smash", text: "\\smash", insert: "\\smash{%<content%>}", type: "insert" },
            { id: "mathstrut", text: "\\mathstrut", insert: "\\mathstrut", type: "insert" },
            { id: "vphantom", text: "\\vphantom", insert: "\\vphantom{%<content%>}", type: "insert" },
            { id: "hphantom", text: "\\hphantom", insert: "\\hphantom{%<content%>}", type: "insert" },
            { id: "phantom", text: "\\phantom", insert: "\\phantom{%<content%>}", type: "insert" },
          ]
        },
